...
public class FileServiceImpl implements FileService {
	...
	public String add(HttpServletRequest request, MultipartFile attachment, String dir) throws CustomException {
		try {
			...
			throw new CustomException(ErrorMessage.ERROR_FILE_ADD, e.getMessage());
		}
	...
	public void download(HttpServletRequest request, HttpServletResponse response, 
		...
		// 서버에 저장된 파일 경로 불러오기
		String directory = request.getServletContext().getRealPath(Common.PREFAB_DIRECTORY);
		...
		try {
			...
			throw new CustomException(ErrorMessage.ERROR_FILE_DOWN, e.getMessage());	
		}
	}
	...
	public void remove(HttpServletRequest request, String filename, String dir) throws CustomException {
		...
		if (filename != null && !filename.trim().isEmpty()) {
			...
			try {
				...
				throw new CustomException(ErrorMessage.ERROR_INCODING, e.getMessage());
			}
